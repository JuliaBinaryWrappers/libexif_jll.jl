...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libexif_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cdeeb48b-bcdf-5b3f-98c4-7a29487f695f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libexif", artifacts_toml) for e in artifacts["libexif"]]
...
if best_platform === nothing
    @debug("Unable to load libexif; unsupported platform $(triplet(platform_key_abi()))")
else
